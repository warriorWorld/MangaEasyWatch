...
public class NewMangaAdapter extends PagerAdapter {
...
//    }
    ...
    public NewMangaAdapter(Context context, ArrayList<String> pathList) {
...
//        v0.setImageBitmap(bp);
        ImageLoader.getInstance().displayImage(pathList.get(position), v0, Globle.options);
