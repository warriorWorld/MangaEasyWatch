package com.warrior.hangsu.administrator.mangaeasywatch.brokenline.paint;
...
import com.warrior.hangsu.administrator.mangaeasywatch.brokenline.calculate.Calculator;

import java.util.ArrayList;

public class BrokenLineView extends View implements Calculator.OnCalculatorResultListener {
    ...
    public BrokenLineView(Context context, AttributeSet attrs) {
        ...
        lineColor = context.getResources().getColor(R.color.line);
        switch (i) {
            case 0:
...
//                        }
    ...
    public void showCalculatorDialog() {
        initXList();
        calculator = new Calculator(context, XList);
        calculator.setOnCalculatorResultListener(this);
        calculator.show();
    }
    ...
    public void onCalculatorResult(String formula, ArrayList<PointF> res,
        ...
        if (res.size() > 0) {
            ...
            for (int i = 0; i < this.specialPoint.size(); i++) {
                Log.d("sss", "specialPoint.size():" + this.specialPoint.size()
                        + "ֵΪ:" + this.specialPoint.get(i));
            }
